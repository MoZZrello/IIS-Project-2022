    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ISSapp.user_roles')),
            ],
        ),
        migrations.CreateModel(
            name='requests',
            fields=[
                ...
                ('animal', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='ISSapp.animal')),
                ('contractor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='contractor_name', to='ISSapp.user')),
                ('solver', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.PROTECT, related_name='solver_name', to='ISSapp.user')),
            ],
        ),
        migrations.CreateModel(
            name='record',
            fields=[
                ...
                ('animal', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ISSapp.animal')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('animal', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ISSapp.animal')),
                ('user_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ISSapp.user')),
            ],
        ),
    ]
